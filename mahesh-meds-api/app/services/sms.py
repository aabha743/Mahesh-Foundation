...
SMS_TEMPLATE_SEEDS: list[tuple[str, str, str | None]] = [
    ...
    ("device_issued_user", "Devices have been issued by Mahesh Foundation Medical Equipment services against Token: {token_number}. Items:{items}. -MHSFND", "1207178299880758060"),
