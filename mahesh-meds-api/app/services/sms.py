...
SMS_TEMPLATE_SEEDS: list[tuple[str, str, str | None]] = [
    ...
    ("request_submitted_approver", "Mahesh Foundation: New request {token_number} for {requestor_name}. Please review.", None),
    ...
    ("device_issued_user", "Mahesh Foundation: Devices for token {token_number} were issued. Due date: {due_date}.", None),
